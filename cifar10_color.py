...
Original file is located at
    https://colab.research.google.com/drive/139OgoKYgfUaQNQNp4WwfbJYbP_CLGdmS
"""
...
- 컬러이미지는 데이터 증식을 하면 정확도가 올라감
- 추가로 Dropout 기법을 사용하여 과적합을 방지함

- 출처: 알렉스
https://modulabs.co.kr/blog/alexnet_structure/

※ 데이터증식은 train_data에만 적용한다! (test X)
"""
...
transform_train = transforms.Compose([
    ...
    transforms.ToTensor(),
    transforms.Normalize((0.4914, 0.4822, 0.4465), (0.2023, 0.1994, 0.2010)),  # 정규화 # RGB의
])
...
train_loader = DataLoader(train_dataset, batch_size=batch_size, shuffle=True, num_workers=2)    # num_workers : CPU 할당 (-1 : full)
...
class CIFAR10Net(nn.Module):
    def __init__(self):
        ...
        self.fc2 = nn.Linear(512, 10)  # 512 유닛을 10개의 클래스로 변환
...
if __name__ == '__main__':
    ...
    for epoch in range(epochs):
        ...
        valid_or_test('valid', model, device, test_loader, test_loader)
